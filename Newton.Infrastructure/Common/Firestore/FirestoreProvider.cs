...
public class FirestoreProvider
{
	...
	public async Task<IReadOnlyCollection<T>?> GetAll<T>(CancellationToken ct = default) where T : class, IFirestoreEntity
	{
		var collection = _fireStoreDb.Collection(GetCollectionName<T>());
	...
	public async Task<IReadOnlyCollection<T>> WhereEqualTo<T>(string fieldPath, object value, CancellationToken ct = default) where T : class, IFirestoreEntity
	{
